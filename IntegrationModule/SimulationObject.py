...
def prepare_inputs_for_trajectory_module(thrust_vector, isp_vector, simulation_time, dt):
    ...
    # TODO: Redo the if when implementing the variable ISP
...
class SimulationObject:
    ...
    def __init__(self, initializer_collection=None):
        ...
        self.mass_simulator_module = self._generate_mass_simulator_module()
    ...
    def _generate_mass_simulator_module(self):
        """
        ...
        if self.initialization_object:
            ...
            obj = System(**self.initialization_object.mass_simulator_parameters)
        else:
            # Set the object to None value, issue warning
    ...
    def run_simulation(self):
        ...
        isp = combustion_results['magnitudes']['isp']
